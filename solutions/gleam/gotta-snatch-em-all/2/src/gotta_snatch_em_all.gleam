...
pub fn new_collection(card: String) -> set.Set(String) {
  set.from_list([card])
}
...
pub fn boring_cards(collections: List(set.Set(String))) -> List(String) {
...
pub fn total_cards(collections: List(set.Set(String))) -> Int {
...
pub fn shiny_cards(collection: set.Set(String)) -> set.Set(String) {
